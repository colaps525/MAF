...
def attr_to_id(path):
  ...
  df_id.to_csv('/Users/kojimajun/MultiAspectForensics/Python/MAF/result_id.csv',index=False,header=False)

  #df.to_csv('/Users/kojimajun/MultiAspectForensics/Python/MAF/result_all.csv',index=False,header=True)

  return df,dim_cols,value_col


if __name__ == '__main__':
  path = '/Users/kojimajun/MultiAspectForensics/Python/MAF/データ準備(tcpdump)/result.csv'
  attr_to_id(path)